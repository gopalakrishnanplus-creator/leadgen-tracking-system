...
urlpatterns = [
    ...
    path("supervisor/provider-activity/", views.leadgen_provider_activity_dashboard, name="leadgen_provider_activity_dashboard"),
    path("supervisor/provider-activity/entry/", views.leadgen_provider_activity_entry, name="leadgen_provider_activity_entry"),
